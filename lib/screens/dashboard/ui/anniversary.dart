                ...
                itemBuilder: (context, index) {
                  ...
                  return Padding(
                    ...
                    child: ChoiceChip(
                      ...
                      selected: isSelected,
                      showCheckmark: false,
                      selectedColor: const Color(0xFFE91E63), // Pink for Anniversaries
                        ...
                        Column(
                          children: [
                            ...
                            if (member.anniversaryDate != null)
                              Text(
                                'Anniversary: ${DateFormat('dd MMMM yyyy').format(member.anniversaryDate!)}',
                              ...
                              child: member.image != null && member.image!.isNotEmpty
                                  ? Image.network(
                                      ...
                                      errorBuilder: (context, error, stackTrace) =>
                                          const Icon(Icons.person, color: Color(0xFFE91E63), size: 40),
                                    )
                                  : const Icon(Icons.person, color: Color(0xFFE91E63), size: 40),
                            ),
                          ),
  ...
  Widget _buildMemberTile(BirthdayModel member) {
    ...
    return GestureDetector(
      ...
      child: Container(
        margin: const EdgeInsets.only(bottom: 12),
        decoration: BoxDecoration(
          color: isToday ? Colors.pink.withOpacity(0.05) : Colors.white,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: isToday ? Colors.pink.withOpacity(0.5) : const Color(0xFFE0E0E0), 
        ...
        child: Row(
          children: [
            CircleAvatar(
              radius: 24,
              backgroundColor: isToday ? Colors.pink.withOpacity(0.2) : Colors.grey.withOpacity(0.1),
              backgroundImage: member.image != null && member.image!.isNotEmpty
                  ? NetworkImage(member.image!)
                  : null,
              child: member.image == null || member.image!.isEmpty
                  ? Icon(Icons.favorite, color: isToday ? Colors.pink : Colors.grey)
                  : null,
            ),
